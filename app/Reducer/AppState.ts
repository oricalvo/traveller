...
export interface TC_Stress{
    readonly Stress:Stress;
    readonly ovenCycleCounter:number;
    readonly lastUpdateDate:string;
    readonly cycleAverageDuration:number;
}

export interface TC_StressesState{
    readonly data: TC_Stress[];
    readonly selected:TC_Stress;
...
export interface StressesState{
    readonly data: Stress[]
    readonly selected:Stress
}
...
export interface FabricatorsState{
...
{
    readonly localHostPath:string;


}
export interface TravelerConfigState{
    readonly TravelerConfig: TravelerConfig;
...
export interface TravelerObject{
    ...
    // Status will be used to indicate TravelerObject status
    //1=first time TravelerObject Arrived from the server
    //2=TravelerObject is in Update State
    //3=TravelerObject Arrived from the client after update/save
...
export interface AppState {
    ...
    readonly stresses:StressesState;
    readonly tc_stresses:TC_StressesState;
